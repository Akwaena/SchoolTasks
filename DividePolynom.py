...
def main():
    ...
    while True:
        ...
        if command == 'help':
            ...
            print('Существует 3 типа деления: all - возврат частного и остатка, int - возврат частного, '
                  'rest - возврат остатка')
            print(divide_polynom(input('Введите делимый многочлен: '), input('Введите многочлен-делитель: '),
                                 input('Введите тип деления: ')))
        else:
